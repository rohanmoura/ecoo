...
const CategoriesSidebar = ({ open, onOpenChange }: types) => {
                ...
                <ScrollArea className='flex flex-col overflow-y-auto h-full pb-2'>
                    ...
                    {currentCategories.map((category) => (
                        <button key={category.slug}
                            onClick={() => handleCategoryClick(category)} className='w-full text-left p-4 hover:bg-black hover:text-white flex justify-between items-center text-base font-medium cursor-pointer'>
                            {category.name}
